...
### 2. [Gallade](https://pokemondb.net/pokedex/gallade/moves/9) (The Capture Specialist)
...
### 3. [Hisuian Zoroark](https://pokemondb.net/pokedex/zoroark/moves/9) (The Illusion Sweeper)
* **Type:** Normal / Ghost
* **Tera Type:** Ghost
* **Role:** Special Attacker / Attack Debuffer
...
### 4. [Haxorus](https://pokemondb.net/pokedex/haxorus/moves/9) (The Shield Breaker)
* **Type:** Dragon
* **Tera Type:** Dragon
* **Role:** Physical Sweeper / Screen Breaker
...
### 5. [Hisuian Zoroark (Event)](https://pokemondb.net/pokedex/zoroark/moves/9) (The Resource Farmer)
* **Type:** Normal / Ghost
* **Tera Type:** Dark
...
### 6. [Slowbro](https://pokemondb.net/pokedex/slowbro/moves/9) (The Iron Bulwark)
* **Type:** Water / Psychic
* **Tera Type:** Water
...
### 7. [Walking Wake](https://pokemondb.net/pokedex/walking-wake/moves/9) (The Ancient Hydro)
* **Type:** Water / Dragon
* **Tera Type:** Flying
...
* **Held Item:** Shell Bell
* **Moveset:**
    * `Chilling Water` (Utility Attack Drop)
    * `Hydro Steam` (Sun/Rain Scalable STAB)
    * `Hurricane` (High Power Flying STAB)
    * `Rain Dance` (Self-Buffing Weather)

### 8. [Toxapex](https://pokemondb.net/pokedex/toxapex/moves/9) (The Unkillable Bunker)
* **Type:** Poison / Water
* **Tera Type:** Poison
* **Role:** Support / Defensive Pivot / Sp. Def Debuffer
* **Nature:** Bold (+Defense, -Attack)
...
### 9. [Bellibolt](https://pokemondb.net/pokedex/bellibolt/moves/9) (The Static Engine)
* **Type:** Electric
* **Tera Type:** Electric
* **Role:** Solo Raid Sweeper / Sp. Def Debuffer
* **Nature:** Modest (+Sp. Atk, -Attack)
...
### 10. [Tsareena](https://pokemondb.net/pokedex/tsareena/moves/9) (The Trop Queen)
* **Type:** Grass
* **Tera Type:** Grass
* **Role:** Physical Support / Sleep Defense
* **Nature:** Adamant (+Attack, -Sp. Atk)
