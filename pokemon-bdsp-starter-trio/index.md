# 🌊 Sinnoh Starter Trio | Shining Pearl Roster ⚔️

**Back to Main:** [https://phuchduong.github.io/MoogleSaveBook/](https://phuchduong.github.io/MoogleSaveBook/)

**Website:** [https://phuchduong.github.io/MoogleSaveBook/pokemon-bdsp-starter-trio/](https://phuchduong.github.io/MoogleSaveBook/pokemon-bdsp-starter-trio/)
...
* [Togekiss](https://pokemondb.net/pokedex/togekiss/moves/8)
    * `Dazzling Gleam`
    * `Air Slash` (60% Flinch chance; the core of the build.)
    * `Tri Attack` (40% Status chance (Burn/Freeze/Paralyze).)
    * `Ancient Power` / `Water Pulse` / `Nasty Plot` / `Stored Power` / `Protect` / `Roost`
